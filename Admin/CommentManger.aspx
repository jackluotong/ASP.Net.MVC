                ...
                <td align="left" colspan="10" height="36">
                    <asp:GridView ID="gvInfo" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                        ...
                        <asp:TemplateField HeaderText="评论人">
                            <ItemTemplate>
                                <asp:Label ID="UserName" runat="server" Text='<%# Bind("UserName") %>' Width="255px"></asp:Label>
                            </ItemTemplate>
                            <ItemStyle HorizontalAlign="Left" Width="100px" />
                        </asp:TemplateField>
                          <asp:TemplateField HeaderText="内容">
                            <ItemTemplate>
                                <asp:Label ID="Titles" runat="server" Text='<%# Bind("Titles") %>' Width="351px"></asp:Label>
                            </ItemTemplate>
                            <ItemStyle HorizontalAlign="Left" Width="100px" />
                        </asp:TemplateField>
                          
                   <asp:TemplateField HeaderText="查看评论服装">
                            <ItemTemplate>
                                <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl='<%# "ModifyShangPin.aspx?id="+Eval("ShangPinID") %>'
                                    Text="查看评论服装" Width="120px"></asp:HyperLink>
                            </ItemTemplate>
