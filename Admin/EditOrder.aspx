                ...
                <td align="left" colspan="10" height="36">
                    ...
                    <asp:GridView ID="gvPOInfo" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="ShangPinName" HeaderText="服装名称" />
                            <asp:BoundField DataField="ShangPinPrice" HeaderText="服装价格" />
                            <asp:BoundField DataField="OrderDate" HeaderText="订单日期" />
                             <asp:BoundField DataField="OrderStite" HeaderText="订单状态" />
                              <asp:BoundField DataField="QinShi" HeaderText="固定电话" />
