<%@ Page Language="C#" AutoEventWireup="true" CodeFile="JiJieManger.aspx.cs" Inherits="AdminManger_JiJieManger" %>
        ...
        <table align="center" bgcolor="#e3ebfe" border="0" cellpadding="2" cellspacing="1"
            ...
            <tr align="right" bgcolor="#eef4ea">
                <td align="center" colspan="10" height="36">
                    季节名称：<asp:TextBox ID="txtname" runat="server" Width="216px"></asp:TextBox>
            ...
            <tr align="right" bgcolor="#eef4ea">
                <td align="left" colspan="10" style="height: 36px">
                    <asp:GridView ID="gvInfo" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            <asp:TemplateField HeaderText="季节名称">
                                <ItemTemplate>
                            ...
                            <asp:TemplateField HeaderText="修改">
                                <ItemTemplate>
                                    <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl='<%# "XiuGaiJiJie.aspx?id="+Eval("id") %>'
